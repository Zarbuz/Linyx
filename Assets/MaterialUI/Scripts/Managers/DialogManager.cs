...
namespace MaterialUI
{
    ...
    public class DialogManager : MonoBehaviour
    {
        ...
        public static DialogGradient ShowDialogGradient()
        {
            DialogGradient dialog = PrefabManager.InstantiateGameObject(PrefabManager.ResourcePrefabs.dialogGradient, instance.transform).GetComponent<DialogGradient>();
            dialog.Initialize();
            dialog.Show();
            return dialog;
        }

        public static DialogColorPicker ShowDialogColorPicker()
        {
            DialogColorPicker dialog = PrefabManager.InstantiateGameObject(PrefabManager.ResourcePrefabs.dialogColorPicker, instance.transform).GetComponent<DialogColorPicker>();
            dialog.Initialize();
            dialog.Show();
            return dialog;
        }

        public static DialogExportVideo ShowDialogExportVideo()
        {
            DialogExportVideo dialog = PrefabManager.InstantiateGameObject(PrefabManager.ResourcePrefabs.dialogExportVideo, instance.transform).GetComponent<DialogExportVideo>();
            dialog.Initialize();
            dialog.isModal = true;
            dialog.Show();
            return dialog;
