...
namespace MaterialUI
{
	...
	public static class PrefabManager
	{
		...
		public static class ResourcePrefabs
		{
            ...
            public const string dialogGradient = "Dialogs/DialogGradient";
            public const string dialogColorPicker = "Dialogs/DialogColorPicker";
            public const string dialogExportVideo = "Dialogs/DialogExportVideo";
            /// <summary>
